...
<!--
Author: Milton Bain
Purpose: This page acts as the main landing platform for admin processes. The admin can choose functions to interact
	with the databaes from dropdowns on this page. The admin can also access the "Other Admin" processes from this page.
	The admin can also logout from this page.
Permissions:
	Admin:
		Select and action and a database to execute processes
		
	Users:
		None
		
Input: Action and Database from dropdowns
Output: N/A
		...
		<div class="container bg-white text-dark d-flex flex-column pb-2">
			<div class="justify-content-left align-self-center">
				...
				<div class="container">
					...
					<form action="otherAdmin.php" method="post">
						<hr>
						<div class="d-flex justify-content-center mb-3">
							<button id="submit" type="submit" class="btn btn-secondary p-2"> Other Admin Processes </button>
						</div>	
					</form>
				</div>
			</div> 
