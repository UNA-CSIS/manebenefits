			...
			<div class="container bg-white text-dark d-flex flex-column pb-2">
				<div class="justify-content-left align-self-center">
					...
					<form action="checkAdmin.php" method="post">
						<p class="font-weight-bold">Username:</p> <input type="text" class="form-control" name="username" id="username" required autocomplete="off"> <br><br>
						<p class="font-weight-bold">Password:</p> <input type="password" class="form-control" name="password" id="password" required autocomplete="off"> <br><br>
