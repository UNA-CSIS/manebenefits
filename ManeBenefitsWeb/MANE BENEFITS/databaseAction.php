<?php 
	...
	/*
		Author: Milton Bain
		Purpose: This page acts as the landing platform for the "adminPage.php" selected action and database. From the selection,
			this page displays the appropriate form to submit to "adminProcess.php". If the action selected is VIEW-*, this page 
			makes a database call and displays all the appropriate nformation from the database on this page. The admin can then
			return to the admin page.
		Permissions:
			Admin:
				Fill out appropriate forms OR view the information requested
				
			Users:
				None
				
		Input: Forms must be filled out appropriately and submitted to "adminProcess.php"
		Output: If VIEW is selected, the output is all the requested database information
				...
				<div class='justify-content-left align-self-center mt-5'>
					...
					<div class='d-flex justify-content-center'>
						<form action='adminPage.php' method='get'>
							<button class='btn btn-secondary' type='submit' name='adminPage' id='adminPage'>Return to Admin Page</button>
						</form>
					</div>
					<br>
...
";
	...
	// If Add to the Business database --------------------------------------------------------------------------------------------------------------
	...
	// If Delete from the Business database ---------------------------------------------------------------------------------------------------------
	if($databaseChoice == "business" && $actionChoice == "delete") {
		...
		";
						...
						$result = $mysqli->query('SELECT ID,name FROM businesses ORDER BY name');
	...
	// If Delete from the Card database -------------------------------------------------------------------------------------------------------------
	...
	// If Delete from the Admin database ------------------------------------------------------------------------------------------------------------
